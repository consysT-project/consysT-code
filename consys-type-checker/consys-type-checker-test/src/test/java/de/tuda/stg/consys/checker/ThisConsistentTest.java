...
public class ThisConsistentTest extends CheckerFrameworkPerFileTest {

    public ThisConsistentTest(File file) {
        super(
                file,
                ConsistencyChecker.class,
                "testfiles/thisConsistent",
    ...
    public static String[] getTestDirs() {
        return new String[] {"testfiles/thisConsistent"};
    }
}
