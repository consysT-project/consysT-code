...
import de.tuda.stg.consys.invariants.solver.subset.utils.Z3SubstitutionFunction1;
...
public class MergeMethodPreconditionExpressionParser extends MethodExpressionParser {
	...
	protected Expr parseJmlMessageSend(JmlMessageSend jmlMessageSend, int depth) {
		...
		if (JDTUtils.methodMatchesSignature(jmlMessageSend.actualReceiverType, methodBinding, true, "de.tuda.stg.consys.invariants.utils.InvariantUtils", "__merge", "java.lang.Object")) {
