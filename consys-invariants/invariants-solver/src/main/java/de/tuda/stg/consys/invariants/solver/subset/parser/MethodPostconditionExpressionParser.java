...
public class MethodPostconditionExpressionParser extends MethodExpressionParser {
	...
	protected Expr parseJmlMessageSend(JmlMessageSend jmlMessageSend, int depth) {
		...
		if (JDTUtils.methodMatchesSignature(jmlMessageSend.actualReceiverType, methodBinding, true, "de.tuda.stg.consys.invariants.utils.InvariantUtils", "stateful", "java.lang.Object")) {
