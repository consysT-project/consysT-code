...
import de.tuda.stg.consys.core.legacy.akka.Mergeable;
import de.tuda.stg.consys.utils.InvariantUtils;

import java.io.Serializable;

/* There is always a replica who holds the lock */
@ReplicatedModel public class DistributedLock implements CanBeMerged<DistributedLock>, Serializable {
    ...
    public int numOfReplicas = InvariantUtils.numOfReplicas();
    ...
    public DistributedLock(int id) {
        ...
        this.replicaId = InvariantUtils.replicaId();
