...
/**
	...
	* @author Mirko Köhler
	*/
trait SysnameSnapshotIsolatedTransactionStore[Id, Key, Data, TxStatus, Consistency, Isolation] extends SysnameBaseStore[Id, Key, Data, TxStatus, Consistency, Isolation] {
