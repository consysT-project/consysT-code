...
/**
	...
	* @author Mirko Köhler
	*/
trait SysnameReadCommittedTransactionStore[Id, Key, Data, TxStatus, Consistency, Isolation] extends SysnameBaseStore[Id, Key, Data, TxStatus, Consistency, Isolation] {
