...
//import de.tuda.stg.consys.objects.actors.Requests.{AsynchronousRequest, Operation}
...
//
//	trait CassandraReplicatedObject[Addr, T <: AnyRef] extends AkkaReplicatedObject[Addr, T] {
//		override final def consistencyLevel : ConsistencyLevel = Weak
//	}
//
//
//	case class PropagateOperation(op : Operation[_]) extends AsynchronousRequest[Unit]
//
//	class CassandraReplicatedObject[Addr, T <: AnyRef](
//		init : T, val addr : Addr, val replicaSystem : AkkaReplicaSystem[Addr],
//	)(
//		protected implicit val ttt : TypeTag[T]
//	) extends CassandraReplicatedObject[Addr, T]	{
//		setObject(init)
//
