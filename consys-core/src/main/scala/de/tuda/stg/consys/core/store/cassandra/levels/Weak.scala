...
//
//		override def writeRaw[T <: StoreType#ObjType : ClassTag](addr : StoreType#Addr, obj : T, txContext : StoreType#TxContext) : StoreType#HandlerType[T] = {
//			val cassObj = new WeakCassandraObject(addr, obj, store, txContext)
//			cassObj
//		}
//
//		override def readRaw[T <: StoreType#ObjType : ClassTag](addr : StoreType#Addr, txContext : StoreType#TxContext) : StoreType#HandlerType[T] = {
