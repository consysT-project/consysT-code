...
import de.tuda.stg.consys.core.store.legacy.ConsistencyLabel.CmRDT
import de.tuda.stg.consys.core.store.legacy.akka.CmRDTAkkaReplicaSystem.CmRDTReplicatedObject
import de.tuda.stg.consys.core.store.legacy.akka.Requests.{InvokeOp, NoAnswerRequest, Operation, Request}
