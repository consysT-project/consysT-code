...
import org.conloc.invariants.solver.subset.model.FieldModel;
...
public class MethodPostconditionExpressionParser extends MethodExpressionParser {
	...
	protected Expr parseJmlMessageSend(JmlMessageSend jmlMessageSend, int depth) {
		...
		if (JDTUtils.methodMatchesSignature(jmlMessageSend.actualReceiverType, methodBinding, true, "org.conloc.invariants.utils.InvariantUtils", "stateful", "java.lang.Object")) {
