...
import org.conloc.invariants.solver.EclipseCompilerBinding;
import org.conloc.invariants.solver.subset.BaseClassProperties;
import org.conloc.invariants.solver.subset.ClassProperties;
import org.conloc.invariants.solver.subset.ProgramConfig;
import org.conloc.invariants.solver.subset.ReplicatedClassProperties;
import org.conloc.invariants.solver.subset.constraints.BaseClassConstraints;
import org.conloc.invariants.solver.subset.constraints.ReplicatedClassConstraints;
import org.conloc.invariants.solver.subset.model.types.TypeModelFactory;
...
public class ProgramModel {
	...
	public static void loadZ3Libs() {
		...
		Path libFolder = Paths.get("conloc-invariants", "conloc-compiler", "lib");
		...
		for (var jmlType : declarations) {
			if (jmlType.annotations != null) {
				var hasDataModelAnnotation = Arrays.stream(jmlType.annotations)
						.anyMatch(anno -> JDTUtils.typeIsTypeOfName(anno.resolvedType, "org.conloc.annotations.invariants.DataModel"));
				var hasReplicatedModelAnnotation = Arrays.stream(jmlType.annotations)
						.anyMatch(anno -> JDTUtils.typeIsTypeOfName(anno.resolvedType, "org.conloc.annotations.invariants.ReplicatedModel"));
