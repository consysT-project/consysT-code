...
import org.conloc.invariants.utils.InvariantUtils;
...
public class BaseExpressionParser extends ExpressionParser {
  ...
  protected Expr parseJmlMessageSend(JmlMessageSend jmlMessageSend, int depth) {
    ...
    //Consys Arrays
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, false, "org.conloc.invariants.lib.Array", "get", "int")) {
      var receiverExpr = parseExpression(jmlMessageSend.receiver, depth + 1);
      var argExpr = parseExpression(jmlMessageSend.arguments[0], depth + 1);
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, false, "org.conloc.invariants.lib.Array", "set", "int", "java.lang.Object")) {
      var receiverExpr = parseExpression(jmlMessageSend.receiver, depth + 1);
