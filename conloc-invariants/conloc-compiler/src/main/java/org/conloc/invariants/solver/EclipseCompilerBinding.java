...
public class EclipseCompilerBinding {
    ...
    public static CompileResult compile(Path[] additionalClassPath, Path[] sourceFiles) {
        ...
        classPath[0] = Paths.get("conloc-invariants", "conloc-compiler", "src", "main", "resources", "rt-1.7.jar");
        classPath[1] = Paths.get("conloc-invariants", "conloc-compiler", "src", "main", "resources", "scala-library-2.13.8.jar");
